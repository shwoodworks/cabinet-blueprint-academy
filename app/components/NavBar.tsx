...
export async function NavBar() {
  ...
  return (
    <header className="print:hidden flex items-center justify-between border-b border-neutral-800 bg-navy px-6 py-4">
      ...
      {user && (
        <nav className="flex items-center gap-4 text-sm text-neutral-200">
          ...
          <form action={signOut}>
            <button type="submit" className="text-neutral-400 hover:text-white">Sign out</button>
          </form>
        </nav>
      )}
    </header>
